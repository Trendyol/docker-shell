...
type Commands struct {
	...
	DockerServiceSuggestions []prompt.Suggest
}
...
func (c *Commands) GetDockerServiceSuggestions() []prompt.Suggest {
	return c.DockerServiceSuggestions
}
...
func (c *Commands) IsDockerServiceCommand(kw string) bool {
	for _, cmd := range c.DockerServiceSuggestions {
		if cmd.Text == kw {
			return true
		}
	}
